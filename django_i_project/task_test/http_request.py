...
class HttpRequest:
    ...
    def _post_request(cls, url, parameter):
        ...
        ret = requests.post(url, json=parameter, header=header, timeout=30)
        ret.encoding = 'utf-8'
        return ret.text
    ...
    def _delete_request(cls, url, parameter):
        ...
        ret = requests.delete(url, json=parameter, header=header, timeout=30)
        ret.encoding = 'utf-8'
        return ret.text
    ...
    def _put_request(cls, url, parameter):
        ...
        ret = requests.put(url, json=parameter, header=header, timeout=30)
        ret.encoding = 'utf-8'
        return ret.text
